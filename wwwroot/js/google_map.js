...
function init() {
    ...
    var myLatlng = new google.maps.LatLng(38.9446394, -119.9548364);
    // 39.399872
    // -8.224454
    ...
    var addresses = ['1142 Ski Run Blvd, South Lake Tahoe, CA 96150'];

    var iconBase = 'https://maps.google.com/mapfiles/kml/shapes/';

    for (var x = 0; x < addresses.length; x++) {
        $.getJSON('https://maps.googleapis.com/maps/api/geocode/json?key=AIzaSyA0r0Po3ucdSIEcEKPvgbYYckIJNXcgrLM&address=' + addresses[x], null, function (data) {            
            if (data.results.length > 0) {
                ...
                new google.maps.Marker({
                    position: latlng,
                    map: map,
                    title: 'Shangrila Himalayan Kitchen',
                    icon: '<i class="trophy"></i>'
                });
            }
        });
    }    
